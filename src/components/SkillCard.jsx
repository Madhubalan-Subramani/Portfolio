  ...
  return (
    ...
    >
      <motion.img
        src={skill.logo}
        alt={skill.name}
        className="h-[50%] object-contain mb-2 group-hover:hidden transition duration-300"
        variants={contentVariants}
      />

      <motion.div
        className="hidden group-hover:block md:w-[70px] md:h-[70px] w-[50px] h-[50px] "
        variants={contentVariants}
      >
        <AnimatedProgressbar percent={skill.percent} isVisible={hovered} />
      </motion.div>
